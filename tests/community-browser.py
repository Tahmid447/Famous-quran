...
report={'scope':'Controlled fixtures and, when ffmpeg is available, a synthetic MP4; not physical iPhone PiP','checks':[],'errors':[]}
    ...
    try:
        ...
        if shutil.which('ffmpeg'):
            with tempfile.TemporaryDirectory() as temp:
                ...
                page.wait_for_function("document.querySelector('#nativeVideo').readyState>=2")
                page.click('#nativeVideoMode');page.wait_for_timeout(800)
        ...
        else: report['media']='SKIPPED: ffmpeg unavailable; no claim of successful media decoding'
